...
import 'package:memorydemo/util/assets.dart';
...
void main() async {
  ...
  var path = await sqfliteDatabaseFactory.getDatabasePath("memorydemo.db");
  ...
  var appDatabase =
      await $FloorAppDatabase.databaseBuilder("memorydemo.db").build();
  Get.put(appDatabase);
