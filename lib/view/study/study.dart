...
import 'package:memorydemo/widget/rotate_widget.dart';
...
/// 学习页面
/// 单词学习的主界面，包含单词展示、播放控制、学习/复习操作
/// 支持自动播放、手动切换、PASS/删除等操作
class StudyPage extends GetView<StudyController> {
  ...
  /// 显示播放设置底部弹窗
  /// 设置每日词汇量、思考等待时间、阅读等待时间、循环队列大小、自动PASS等
  /// 修改设置后重新获取单词并保持播放状态
  ...
  /// 构建设置选项列表视图
  /// 包含五个设置项：每日词汇量、思考等待、阅读等待、循环队列、自动PASS
...
class WordListView extends GetView<WordListController> {
  ...
  /// 构建单词列表项
  /// 显示单词和释义，点击尾部按钮可查看详情或操作单词
  /// [wordStatusUpdateCallback] 单词状态更新后的回调
